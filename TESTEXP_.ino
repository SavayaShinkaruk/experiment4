...
const static char pubChannel[] = "Savaya"; //choose a name for the channel to publish messages to // you reverse these numbers with your partner 
const static char subChannel[] = "Emilia"; //choose a name for the channel to publish messages to // change this to Emilia 
